...
def Front2():
    ...
    root.title(" Logo at background QR code ")
    ...
    color_label =Label(root, text="Enter the Image name", bg="#E8D579")
    ...
    img_label =Label(root, text="Enter the Image name to Save", bg="#E8D579")
    ...
    gen_but = Button(root,text="Generate QR Code", command = lambda: bck.Source2(root.text_entry1.get(),root.text_entry2.get(),root.text_entry3.get()), width=15, bg="#05E8E0")
